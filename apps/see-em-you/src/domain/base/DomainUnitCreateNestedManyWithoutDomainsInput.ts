...
@InputType()
class DomainUnitCreateNestedManyWithoutDomainsInput {
...
export { DomainUnitCreateNestedManyWithoutDomainsInput as DomainUnitCreateNestedManyWithoutDomainsInput };
