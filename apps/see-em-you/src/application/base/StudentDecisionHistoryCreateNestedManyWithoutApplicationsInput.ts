...
@InputType()
class StudentDecisionHistoryCreateNestedManyWithoutApplicationsInput {
...
export { StudentDecisionHistoryCreateNestedManyWithoutApplicationsInput as StudentDecisionHistoryCreateNestedManyWithoutApplicationsInput };
