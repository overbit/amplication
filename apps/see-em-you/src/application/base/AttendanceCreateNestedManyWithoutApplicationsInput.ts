...
@InputType()
class AttendanceCreateNestedManyWithoutApplicationsInput {
...
export { AttendanceCreateNestedManyWithoutApplicationsInput as AttendanceCreateNestedManyWithoutApplicationsInput };
