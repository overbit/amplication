...
@InputType()
class MhciPrereqsCourseCreateNestedManyWithoutApplicationsInput {
...
export { MhciPrereqsCourseCreateNestedManyWithoutApplicationsInput as MhciPrereqsCourseCreateNestedManyWithoutApplicationsInput };
