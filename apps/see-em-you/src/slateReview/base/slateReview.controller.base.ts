...
export class SlateReviewControllerBase {
  ...
  async slateReviews(@common.Req() request: Request): Promise<SlateReview[]> {
    const args = plainToClass(SlateReviewFindManyArgs, request.query);
    return this.service.slateReviews({
      ...args,
      select: {
        first: true,
        id: true,
  ...
  async slateReview(
    ...
    const result = await this.service.slateReview({
      where: params,
      select: {
        first: true,
        id: true,
  ...
  async deleteSlateReview(
    ...
    try {
      return await this.service.deleteSlateReview({
        where: params,
        select: {
          first: true,
          id: true,
