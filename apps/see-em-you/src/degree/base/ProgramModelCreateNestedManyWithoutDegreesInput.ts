...
@InputType()
class ProgramModelCreateNestedManyWithoutDegreesInput {
...
export { ProgramModelCreateNestedManyWithoutDegreesInput as ProgramModelCreateNestedManyWithoutDegreesInput };
