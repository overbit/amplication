...
describe("PromotionStatus", () => {
  ...
  beforeAll(async () => {
    const moduleRef = await Test.createTestingModule({
      providers: [
        {
          provide: PromotionStatusService,
          useValue: service,
        },
      ],
  ...
  test("POST /promotionStatuses", async () => {
    await request(app.getHttpServer())
      .post("/promotionStatuses")
      .send(CREATE_INPUT)
  ...
  test("GET /promotionStatuses", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /promotionStatuses/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/promotionStatuses"}/${nonExistingId}`)
  ...
  test("GET /promotionStatuses/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/promotionStatuses"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /promotionStatuses existing resource", async () => {
