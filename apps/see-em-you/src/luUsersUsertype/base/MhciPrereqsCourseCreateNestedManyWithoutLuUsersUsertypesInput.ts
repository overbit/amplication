...
@InputType()
class MhciPrereqsCourseCreateNestedManyWithoutLuUsersUsertypesInput {
...
export { MhciPrereqsCourseCreateNestedManyWithoutLuUsersUsertypesInput as MhciPrereqsCourseCreateNestedManyWithoutLuUsersUsertypesInput };
