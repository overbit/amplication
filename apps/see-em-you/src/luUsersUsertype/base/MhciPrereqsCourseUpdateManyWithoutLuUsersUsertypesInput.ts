...
@InputType()
class MhciPrereqsCourseUpdateManyWithoutLuUsersUsertypesInput {
...
export { MhciPrereqsCourseUpdateManyWithoutLuUsersUsertypesInput as MhciPrereqsCourseUpdateManyWithoutLuUsersUsertypesInput };
