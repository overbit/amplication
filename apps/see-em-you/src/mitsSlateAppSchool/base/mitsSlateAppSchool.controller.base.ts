...
import { MitsSlateAppSchoolCreateInput } from "./MitsSlateAppSchoolCreateInput";
...
export class MitsSlateAppSchoolControllerBase {
  constructor(protected readonly service: MitsSlateAppSchoolService) {}
  @common.Post()
  @swagger.ApiCreatedResponse({ type: MitsSlateAppSchool })
  async createMitsSlateAppSchool(
    @common.Body() data: MitsSlateAppSchoolCreateInput
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [MitsSlateAppSchool] })
  @ApiNestedQuery(MitsSlateAppSchoolFindManyArgs)
  async mitsSlateAppSchools(
    @common.Req() request: Request
  ): Promise<MitsSlateAppSchool[]> {
    const args = plainToClass(MitsSlateAppSchoolFindManyArgs, request.query);
    return this.service.mitsSlateAppSchools({
      ...args,
      select: {
        prefix: true,
        first: true,
  ...
  async mitsSlateAppSchool(
    @common.Param() params: MitsSlateAppSchoolWhereUniqueInput
  ): Promise<MitsSlateAppSchool | null> {
    const result = await this.service.mitsSlateAppSchool({
      where: params,
      select: {
        prefix: true,
        first: true,
  ...
  async updateMitsSlateAppSchool(
    @common.Param() params: MitsSlateAppSchoolWhereUniqueInput,
    @common.Body() data: MitsSlateAppSchoolUpdateInput
  ): Promise<MitsSlateAppSchool | null> {
    try {
  ...
  async deleteMitsSlateAppSchool(
    ...
    try {
      return await this.service.deleteMitsSlateAppSchool({
        where: params,
        select: {
          prefix: true,
          first: true,
